var ready = function() {
    ...
    if ($('#psap-resources-chart').length) {
        var sourceData = $.parseJSON($('input[name="chart_data"]').val());
        ...
        var vis = d3.select('#psap-resources-chart'),
            WIDTH = $('#psap-resources-chart').width(),
            HEIGHT = $('#psap-resources-chart').height(),
            MARGINS = {
                top: 20,
                right: 20,
                bottom: 20,
