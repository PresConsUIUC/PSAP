...
class Command
  ...
  # Executes the command, raising an exception if anything goes wrong. Raised
  # exception messages should be suitable for public consumption.
  # Success/failure should be written to the event log.
  def execute
